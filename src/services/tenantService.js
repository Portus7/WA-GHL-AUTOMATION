...
async function registerNewTenant(locationId, companyId, initialStatus = 'active', subscriptionId = null, locationName = null) {
    try {
        ...
        const sql = `
            INSERT INTO tenants (location_id, status, trial_ends_at, plan_id, settings, created_at, agency_id, linked_subscription_id, name)
        ...
        await pool.query(sql, [locationId, initialStatus, trialEnd, planId, JSON.stringify(defaultSettings), companyId, subscriptionId, locationName]);
